...
<body>
  ...
  <p class="p-sp"><b> N° pedido asociado:</b>${json.DATOS_INSPECCION.orden_servicio} </p>
  <h3>ACTA ENTREGA DE VEHÍCULOS N°:${json.DATOS_INSPECCION.id_inspeccion}</h3>
  <div class="principal">
    <table>
      <tr>
        ...
        <td><b>Hora Recepción:${
          ...
          json.DATOS_INSPECCION.hora_inspeccion
        } </b></td>
      </tr>
      <tr>
      ...
      <tr>
        <td colspan=3><b>Cliente: </b>${
          json.DATOS_INSPECCION.nombre_cliente
        }</td>
      </tr>
      <tr>
        <td><b>Kilometraje: </b>${json.DATOS_INSPECCION.kilometraje_vehiculo}</td>
        <td><b>Combustible: </b>%${json.DATOS_INSPECCION.combustible_vehiculo}</td>
        <td><b>Tipo de Servicio: </b>${json.DATOS_INSPECCION.tipo_servicio}</td>
      </tr>
      <tr>
        <td><b>Nombre Chofer: </b>${json.DATOS_INSPECCION.nombre_condcutor}</td>
        <td><b>Celular: </b>${json.DATOS_INSPECCION.celular_conductor}</td>
        <td><b>Mail: </b>${json.DATOS_INSPECCION.mail_conductor}</td>
      </tr>
      <tr>
        <td><b>Tipo de Uso: </b>${json.DATOS_INSPECCION.tipo_uso}</td>
        <td><b>Lugar Entrega: </b>${json.DATOS_INSPECCION.lugar_entrega}</td>
        <td><b>Plazo Contrato: </b>${json.DATOS_INSPECCION.plazo_contrato}</td>
      </tr>
      <tr>
        <td><b>Lugar de recogida: </b>${json.DATOS_INSPECCION.lugar_recogida}</td>
      </tr>
      <tr>
  ...
  <div class="page-break";>
    ...
    <div class="tabla-firma">
      <table>
        ...
        <tr>
          <td><b>NOMBRE:</b>GAMA LEASING OPERATIVO SPA</td>
          <td><b>NOMBRE:</b> ${json.DATOS_INSPECCION.nombre_cliente}</td>
        </tr>
        <tr>
          <td><b>RUT:</b> 99525100-0</td>
          <td><b>RUT:</b> ${json.DATOS_INSPECCION.rut_cliente}</td>
        </tr>
      </table>
    </div>
  </div>
    ...
    <div class="imagenes">
      ${json.FOTOS_INSPECCION_OBLIGATORIAS.map(
        (imagen) => `
        <div class="page-break";>
          <div class="header">
            <img src="data:image/svg+xml;base64,">
    ...
    <div class="imagenes">
      ${json.FOTOS_INSPECCION_EXTRAS.map(
        (imagen) => `
        <div class="page-break";>
          <div class="header">
            <img src="data:image/svg+xml;base64,">
  ...
  `;
    ...
    console.log(error)
    return Event.ERRORJSON
  }
};

const Acta2 = async (json) => {
